...
REASON_KEYS = ("reason", "skip_reason", "reject_reason", "rejection_reason", "status_reason", "message")
STATUS_KEYS = ("status", "decision", "result", "sizing_status")
...
def text_report(report: Mapping[str, Any]) -> str:
    ...
    lines = [
        "PHOENIX v7 STEP11 DECISION DIAGNOSTICS", "=" * 76,
...
def print_diagnostics_summary(report: Mapping[str, Any]) -> None:
    print("=" * 80)
    print("PHOENIX v7 STEP11 DECISION DIAGNOSTICS")
    print("=" * 80)
